...
impl GpuLmHeadTrainer {
    ...
    pub fn exact_zero_accumulators(
        ...
        encoder.clear_buffer(&self.dl_dh_buf, 0, Some((seq_len as u64) * (self.config.d_r as u64) * 4));
        queue.submit(Some(encoder.finish()));
    }
